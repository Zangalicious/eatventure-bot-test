...
# Strict Three-Stage Cascade (inRange -> matchShapes -> matchTemplate)
# Stage 1 (BGR color bounds)
BOX_BROWN_BGR_LOWER = (20, 50, 80)
BOX_BROWN_BGR_UPPER = (85, 140, 180)
UPGRADE_STATION_BLUE_BGR_LOWER = (120, 70, 20)
UPGRADE_STATION_BLUE_BGR_UPPER = (255, 210, 110)

# Stage 2 (shape filtering/matching)
STRICT_ASSET_MIN_CONTOUR_AREA = 180
STRICT_ASSET_MAX_CONTOUR_AREA_RATIO = 0.35
STRICT_ASSET_SHAPE_TOLERANCE = 0.16

# Stage 3 (template confidence gate)
STRICT_ASSET_TEMPLATE_THRESHOLD = 0.88
